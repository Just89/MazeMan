package 
{
	...
	public class Main extends Sprite 
	{
		...
		private var _timerTime:int = 301;
		...
		private function startScreen():void
		{
			...
			_subTitle = new TekstField("'Complete as many Mazes as you can while collection as many coins as you can under 5 minutes'", 0xFFFFFF, false, 165, 180);
			_subTitle.width = 500;
			addChild(_subTitle);
